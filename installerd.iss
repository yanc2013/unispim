...
DefaultDirName={pf}\unispim6
DefaultGroupName=Unispim PinYin input (Simplified Chinese)
OutputDir=.
OutputBaseFilename=Unispim-0.0d-setup
Compression=lzma
...
Source: "build\Debug\unispim6.ime"; DestDir: "{sys}"; Flags: ignoreversion
Source: "build\Debug\ime_install.exe"; DestDir: "{app}"; Flags: ignoreversion
